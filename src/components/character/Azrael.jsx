...
import galleryData from '../../data/characterGalleries/azrael.json';
    ...
    <div className="hero-character-page">
      <section className="hero-banner">
        <div className="hero-banner-image">
          <img src={placeholder} alt="Azrael" />
        </div>
      ...
      <section className="hero-content">
        <main className="hero-center">
          ...
          <div className="hero-bio">
            <p>
              Azrael enforces difficult decisions with precision and resolve, acting as the team&apos;s final line when
        ...
        <aside className="hero-right">
          <dl className="hero-stats">
            ...
            <div className="hero-stat"><dt>Aliases</dt><dd>Azrael</dd></div>
