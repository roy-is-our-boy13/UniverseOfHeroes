      ...
      >
        <div className="bio-section">
          <div className="image-wrapper">
            <img src={jungletitan} alt="Jungle Titian" className="AcharacterPose" />
          </div>

          <div className="text-wrapper">
            <h1 className="character-name">JUNGLE TITIAN</h1>
            <h3 className="character-title">Revered Lin Kuei Warrior</h3>
            <div className="bio-description">
              <p>Here goes your character content...</p>
              <p>Add Jungle Titian's bio and backstory here.</p>
            </div>
          </div>
        </div>
      </div>
