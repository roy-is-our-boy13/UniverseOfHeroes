      ...
      >
        <div className="bio-section">
          ...
          <div className="image-wrapper">
            <img src={refectorPose} alt="Reflector pose" className="AcharacterPose" />
          </div>

          {/* Bio Text Content */}
          <div className="text-wrapper">
            <h1 className="character-name">REFLECTOR</h1>
            <h3 className="character-title">Revered Lin Kuei Warrior</h3>
            <div className="bio-description">
              <p>
                Here goes your character content...
              </p>
              <p>
                Add Reflector's bio and backstory here.
              </p>
            </div>
          </div>
        </div>
